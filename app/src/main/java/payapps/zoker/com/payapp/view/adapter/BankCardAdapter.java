 ...
 */
public class BankCardAdapter extends RecyclerView.Adapter<VisitableViewHolder> {
    private VisitableTypeControl.TypeFactory typeFactory;
    private List<BankCard> mDatas;
    public BankCardAdapter(VisitableTypeControl.TypeFactory typeFactory) {
    ...
    public void setmDatas(List<BankCard> mDatas) {
        this.mDatas = mDatas;
