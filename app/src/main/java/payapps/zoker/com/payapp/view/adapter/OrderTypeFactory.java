 ...
 */
public class OrderTypeFactory implements VisitableTypeControl.TypeFactory {
    ...
    private static OrderTypeFactory instance;
    private Map<Integer, Integer> res_map= new HashMap<>();
    {
        ...
        res_map.put(goods_type, R.layout.item_order_goods);
    }

    private OrderTypeFactory() {
    }

    public static OrderTypeFactory getInstance() {
        if (instance == null) {
            synchronized (OrderTypeFactory.class) {
                instance = new OrderTypeFactory();
            }
        }
        return instance;
    }
    ...
    public VisitableViewHolder createViewHolder(int type, View itemView) {
        switch (type) {
            ...
            case goods_type:
                return new OrderGoodsViewHolder(itemView);
