 ...
 */
public class PayAdapter extends RecyclerView.Adapter<VisitableViewHolder> {
    private VisitableTypeControl.TypeFactory typeFactory;
    private List<Details> mDatas;
    public PayAdapter(VisitableTypeControl.TypeFactory typeFactory) {
    ...
    public void setmDatas(List<Details> mDatas) {
        this.mDatas = mDatas;
        notifyDataSetChanged();
    }
    public List<Details> getmDatas(){
        if (this.mDatas==null)
