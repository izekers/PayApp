package com.zekers.utils.permission;
...
public class PermissionManager {
    ...
    public static void askForPermission(Activity activity, String[] permissions, PermissionCallback permissionCallback) {
        Logger.d("permissionManager", "#askForPermission");
        ...
        Logger.d("permissionManager", "#requestPermissions");
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        Logger.d("permissionManager", "#onRequestPermissionsResult,requestCode="+requestCode);
